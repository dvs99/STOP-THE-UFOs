...
namespace UnityTemplateProjects
{
    public class PlayerMovement : MonoBehaviour
    {
        ...
        private void Update()
        {
            ...
            //rotate the model to loo foward
            ...
            if (velocity.magnitude > 0.01)
            {
                ...
                Vector3 rotationTargetDirection = Vector3.RotateTowards(modelFoward, velocity.normalized, Mathf.Deg2Rad * rotationAnimationSpeed, float.PositiveInfinity);
